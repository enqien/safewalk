...
const UpdateForm = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    api
      .post("http://localhost:8080/cases/" + props.DR_NO, formData, options)
  ...
  return (
    <div className="formcontainer">
      <form onSubmit={handleSubmit}>
        ...
        {success && <div>Successfully updated case with id {props.DR_NO}</div>}
        {/* {success == "false" && (
          <div>failed updated case with id {props.DR_NO}</div>
        )} */}
